...
from modules.scene import Scene, Camera, GaussianModel, render, ImageState
...
def render_set(scene:Scene, name:str, pipeline:PipelineParams):
    ...
    elif pipeline.engine_provider == 'depth':
    ...
    for idx, view in enumerate(tqdm(views, desc='Rendering progress')):
        ...
        if pipeline.engine_provider == 'ours-dev':
