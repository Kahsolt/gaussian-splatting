...
from modules.morphs.gs.hparam import HyperParams as HyperParams_SH
from modules.morphs.mlp_gs.hparam import HyperParams as HyperParams_Neural
...
class _GaussianModel:
    ...
    def save_ply(self, path:str):
        ...
        properties = np.concatenate((xyz, scaling, rotation, opacities), axis=1)
...
class GaussianModel_SH(_GaussianModel):
...
class GaussianModel_Neural(_GaussianModel, nn.Module):
