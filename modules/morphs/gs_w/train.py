...
from modules.utils.loss_utils import l1_loss, nerfw_loss, psnr
        ...
        with torch.no_grad():
            ...
            if steps < hp.densify_until_iter:
                ...
                if steps > hp.densify_from_iter and steps % hp.densification_interval == 0:
                    ...
                    gaussians.densify_and_prune(hp.densify_grad_threshold, 0.005, 2.0, scene.cameras_extent, size_threshold)
